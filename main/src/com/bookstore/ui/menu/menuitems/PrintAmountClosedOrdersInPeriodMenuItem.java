...
@Singleton
@MenuItemAnnotation(
        title = "Print amount of closed orders in period",
        currentState = UIState.MAIN,
        nextState = UIState.MAIN
)
public class PrintAmountClosedOrdersInPeriodMenuItem implements MenuItem {
    private final int orderPriority = 5;
    @InjectObject
    ...
    private MenuItemAction action = () -> {
        storeController.printAmountClosedOrders();
    };
